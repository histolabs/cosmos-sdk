...
func (*QueryCurrentPlanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{0}
}
...
func (*QueryCurrentPlanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{1}
}
...
func (*QueryAppliedPlanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{2}
}
...
func (*QueryAppliedPlanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{3}
}
...
func (*QueryUpgradedConsensusStateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{4}
}
...
func (*QueryUpgradedConsensusStateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{5}
}
...
func (*QueryModuleVersionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{6}
}
...
func (*QueryModuleVersionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{7}
}
...
func (*QueryAuthorityRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{8}
}
...
func (*QueryAuthorityResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9861585fee325003, []int{9}
}
...
func init() {
	proto.RegisterType((*QueryCurrentPlanRequest)(nil), "cowsmouse.upgrade.v1beta1.QueryCurrentPlanRequest")
	proto.RegisterType((*QueryCurrentPlanResponse)(nil), "cowsmouse.upgrade.v1beta1.QueryCurrentPlanResponse")
	proto.RegisterType((*QueryAppliedPlanRequest)(nil), "cowsmouse.upgrade.v1beta1.QueryAppliedPlanRequest")
	proto.RegisterType((*QueryAppliedPlanResponse)(nil), "cowsmouse.upgrade.v1beta1.QueryAppliedPlanResponse")
	proto.RegisterType((*QueryUpgradedConsensusStateRequest)(nil), "cowsmouse.upgrade.v1beta1.QueryUpgradedConsensusStateRequest")
	proto.RegisterType((*QueryUpgradedConsensusStateResponse)(nil), "cowsmouse.upgrade.v1beta1.QueryUpgradedConsensusStateResponse")
	proto.RegisterType((*QueryModuleVersionsRequest)(nil), "cowsmouse.upgrade.v1beta1.QueryModuleVersionsRequest")
	proto.RegisterType((*QueryModuleVersionsResponse)(nil), "cowsmouse.upgrade.v1beta1.QueryModuleVersionsResponse")
	proto.RegisterType((*QueryAuthorityRequest)(nil), "cowsmouse.upgrade.v1beta1.QueryAuthorityRequest")
	proto.RegisterType((*QueryAuthorityResponse)(nil), "cowsmouse.upgrade.v1beta1.QueryAuthorityResponse")
}

func init() {
	proto.RegisterFile("cowsmouse/upgrade/v1beta1/query.proto", fileDescriptor_9861585fee325003)
}

var fileDescriptor_9861585fee325003 = []byte{
	// 639 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) CurrentPlan(ctx context.Context, in *QueryCurrentPlanRequest, opts ...grpc.CallOption) (*QueryCurrentPlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cowsmouse.upgrade.v1beta1.Query/CurrentPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AppliedPlan(ctx context.Context, in *QueryAppliedPlanRequest, opts ...grpc.CallOption) (*QueryAppliedPlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cowsmouse.upgrade.v1beta1.Query/AppliedPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) UpgradedConsensusState(ctx context.Context, in *QueryUpgradedConsensusStateRequest, opts ...grpc.CallOption) (*QueryUpgradedConsensusStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cowsmouse.upgrade.v1beta1.Query/UpgradedConsensusState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ModuleVersions(ctx context.Context, in *QueryModuleVersionsRequest, opts ...grpc.CallOption) (*QueryModuleVersionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cowsmouse.upgrade.v1beta1.Query/ModuleVersions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Authority(ctx context.Context, in *QueryAuthorityRequest, opts ...grpc.CallOption) (*QueryAuthorityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cowsmouse.upgrade.v1beta1.Query/Authority", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_CurrentPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cowsmouse.upgrade.v1beta1.Query/CurrentPlan",
	}
...
func _Query_AppliedPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cowsmouse.upgrade.v1beta1.Query/AppliedPlan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_UpgradedConsensusState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cowsmouse.upgrade.v1beta1.Query/UpgradedConsensusState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ModuleVersions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cowsmouse.upgrade.v1beta1.Query/ModuleVersions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Authority_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cowsmouse.upgrade.v1beta1.Query/Authority",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cowsmouse.upgrade.v1beta1.Query",
	...
	Metadata: "cowsmouse/upgrade/v1beta1/query.proto",
}
