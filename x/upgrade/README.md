...
be seamless. This tool is [Cosmovisor](https://github.com/cosmos/cosmos-sdk/v2/tree/main/tools/cosmovisor#readme).
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.47.0-rc1/proto/cosmos/upgrade/v1beta1/tx.proto#L29-L41
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.47.0-rc1/proto/cosmos/upgrade/v1beta1/tx.proto#L48-L57
```
