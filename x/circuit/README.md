...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/v2/blob/main/proto/cosmos/circuit/v1/tx.proto#L25-L75
```
...
```protobuf reference 
https://github.com/cosmos/cosmos-sdk/v2/blob/main/proto/cosmos/circuit/v1/tx.proto#L77-L93
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/v2/blob/main/proto/cosmos/circuit/v1/tx.proto#L95-109
```
