	...
	return func(config *Config) {
		config.ModuleConfigs["mint"] = &appv1alpha1.ModuleConfig{
			...
			GolangBindings: []*appv1alpha1.GolangBinding{
				{
					InterfaceType:  "github.com/cosmos/cosmos-sdk/v2/x/mint/types/types.StakingKeeper",
					Implementation: "github.com/cosmos/cosmos-sdk/v2/x/staking/keeper/*keeper.Keeper",
				},
			},
		}
	}
