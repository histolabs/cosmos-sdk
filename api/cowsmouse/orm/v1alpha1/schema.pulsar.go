...
func init() {
	file_cowsmouse_orm_v1alpha1_schema_proto_init()
	md_ModuleSchemaDescriptor = File_cowsmouse_orm_v1alpha1_schema_proto.Messages().ByName("ModuleSchemaDescriptor")
...
func (x *ModuleSchemaDescriptor) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_orm_v1alpha1_schema_proto_msgTypes[0]
...
func (x *fastReflection_ModuleSchemaDescriptor) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.schema_file":
		return len(x.SchemaFile) != 0
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.prefix":
		return len(x.Prefix) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor"))
		}
		panic(fmt.Errorf("message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.prefix":
		panic(fmt.Errorf("field prefix of message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor"))
		}
...
func (x *fastReflection_ModuleSchemaDescriptor) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_orm_v1alpha1_schema_proto_init()
	md_ModuleSchemaDescriptor_FileEntry = File_cowsmouse_orm_v1alpha1_schema_proto.Messages().ByName("ModuleSchemaDescriptor").Messages().ByName("FileEntry")
...
func (x *ModuleSchemaDescriptor_FileEntry) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_orm_v1alpha1_schema_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.id":
		return x.Id != uint32(0)
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.proto_file_name":
		return x.ProtoFileName != ""
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.storage_type":
		return x.StorageType != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry"))
		}
		panic(fmt.Errorf("message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.id":
		panic(fmt.Errorf("field id of message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry is not mutable"))
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.proto_file_name":
		panic(fmt.Errorf("field proto_file_name of message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry is not mutable"))
	case "cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.storage_type":
		panic(fmt.Errorf("field storage_type of message cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry"))
		}
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/orm/v1alpha1/schema.proto
...
func (StorageType) Descriptor() protoreflect.EnumDescriptor {
	return file_cowsmouse_orm_v1alpha1_schema_proto_enumTypes[0].Descriptor()
}

func (StorageType) Type() protoreflect.EnumType {
	return &file_cowsmouse_orm_v1alpha1_schema_proto_enumTypes[0]
}
...
func (StorageType) EnumDescriptor() ([]byte, []int) {
	return file_cowsmouse_orm_v1alpha1_schema_proto_rawDescGZIP(), []int{0}
}
...
type ModuleSchemaDescriptor_FileEntry struct {
	...
	// module has referenced using cowsmouse.app.v1.ModuleDescriptor.use_package.
	...
	StorageType StorageType `protobuf:"varint,3,opt,name=storage_type,json=storageType,proto3,enum=cowsmouse.orm.v1alpha1.StorageType" json:"storage_type,omitempty"`
}
...
func (*ModuleSchemaDescriptor_FileEntry) Descriptor() ([]byte, []int) {
	return file_cowsmouse_orm_v1alpha1_schema_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_cowsmouse_orm_v1alpha1_schema_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.MessageOptions)(nil),
		ExtensionType: (*ModuleSchemaDescriptor)(nil),
		Field:         104503792,
		Name:          "cowsmouse.orm.v1alpha1.module_schema",
		Tag:           "bytes,104503792,opt,name=module_schema",
		Filename:      "cowsmouse/orm/v1alpha1/schema.proto",
	},
}
...
var (
	...
	// themselves as app module config messages using the cowsmouse.app.v1.is_module
	// option.
	//
	// optional cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor module_schema = 104503792;
	E_ModuleSchema = &file_cowsmouse_orm_v1alpha1_schema_proto_extTypes[0]
)

var File_cowsmouse_orm_v1alpha1_schema_proto protoreflect.FileDescriptor

var file_cowsmouse_orm_v1alpha1_schema_proto_rawDesc = []byte{
	,
	...
	,
	...
	0x45, 0x4e, 0x54, 0x10, 0x02, 0x3a, 0x77, 0x0a, 0x0d, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f,
	...
	0x32, 0x2e, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x6f, 0x72, 0x6d,
	...
	,
}

var (
	file_cowsmouse_orm_v1alpha1_schema_proto_rawDescOnce sync.Once
	file_cowsmouse_orm_v1alpha1_schema_proto_rawDescData = file_cowsmouse_orm_v1alpha1_schema_proto_rawDesc
)

func file_cowsmouse_orm_v1alpha1_schema_proto_rawDescGZIP() []byte {
	file_cowsmouse_orm_v1alpha1_schema_proto_rawDescOnce.Do(func() {
		file_cowsmouse_orm_v1alpha1_schema_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_orm_v1alpha1_schema_proto_rawDescData)
	})
	return file_cowsmouse_orm_v1alpha1_schema_proto_rawDescData
}

var file_cowsmouse_orm_v1alpha1_schema_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_cowsmouse_orm_v1alpha1_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cowsmouse_orm_v1alpha1_schema_proto_goTypes = []interface{}{
	(StorageType)(0),                         // 0: cowsmouse.orm.v1alpha1.StorageType
	(*ModuleSchemaDescriptor)(nil),           // 1: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor
	(*ModuleSchemaDescriptor_FileEntry)(nil), // 2: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry
	(*descriptorpb.MessageOptions)(nil),      // 3: google.protobuf.MessageOptions
}
var file_cowsmouse_orm_v1alpha1_schema_proto_depIdxs = []int32{
	2, // 0: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.schema_file:type_name -> cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry
	0, // 1: cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.storage_type:type_name -> cowsmouse.orm.v1alpha1.StorageType
	3, // 2: cowsmouse.orm.v1alpha1.module_schema:extendee -> google.protobuf.MessageOptions
	1, // 3: cowsmouse.orm.v1alpha1.module_schema:type_name -> cowsmouse.orm.v1alpha1.ModuleSchemaDescriptor
...
func init() { file_cowsmouse_orm_v1alpha1_schema_proto_init() }
func file_cowsmouse_orm_v1alpha1_schema_proto_init() {
	if File_cowsmouse_orm_v1alpha1_schema_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_orm_v1alpha1_schema_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_orm_v1alpha1_schema_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_orm_v1alpha1_schema_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_orm_v1alpha1_schema_proto_goTypes,
		DependencyIndexes: file_cowsmouse_orm_v1alpha1_schema_proto_depIdxs,
		EnumInfos:         file_cowsmouse_orm_v1alpha1_schema_proto_enumTypes,
		MessageInfos:      file_cowsmouse_orm_v1alpha1_schema_proto_msgTypes,
		ExtensionInfos:    file_cowsmouse_orm_v1alpha1_schema_proto_extTypes,
	}.Build()
	File_cowsmouse_orm_v1alpha1_schema_proto = out.File
	file_cowsmouse_orm_v1alpha1_schema_proto_rawDesc = nil
	file_cowsmouse_orm_v1alpha1_schema_proto_goTypes = nil
	file_cowsmouse_orm_v1alpha1_schema_proto_depIdxs = nil
}
