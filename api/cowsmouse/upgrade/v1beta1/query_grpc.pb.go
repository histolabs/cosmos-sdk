...
const (
	Query_CurrentPlan_FullMethodName            = "/cowsmouse.upgrade.v1beta1.Query/CurrentPlan"
	Query_AppliedPlan_FullMethodName            = "/cowsmouse.upgrade.v1beta1.Query/AppliedPlan"
	Query_UpgradedConsensusState_FullMethodName = "/cowsmouse.upgrade.v1beta1.Query/UpgradedConsensusState"
	Query_ModuleVersions_FullMethodName         = "/cowsmouse.upgrade.v1beta1.Query/ModuleVersions"
	Query_Authority_FullMethodName              = "/cowsmouse.upgrade.v1beta1.Query/Authority"
)
