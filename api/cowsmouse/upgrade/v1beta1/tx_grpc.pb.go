...
const (
	Msg_SoftwareUpgrade_FullMethodName = "/cowsmouse.upgrade.v1beta1.Msg/SoftwareUpgrade"
	Msg_CancelUpgrade_FullMethodName   = "/cowsmouse.upgrade.v1beta1.Msg/CancelUpgrade"
)
