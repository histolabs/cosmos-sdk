...
import (
	v1beta1 "cosmossdk.io/api/cowsmouse/crypto/multisig/v1beta1"
	fmt "fmt"
...
func init() {
	file_cowsmouse_tx_signing_v1beta1_signing_proto_init()
	md_SignatureDescriptors = File_cowsmouse_tx_signing_v1beta1_signing_proto.Messages().ByName("SignatureDescriptors")
...
func (x *SignatureDescriptors) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[0]
...
func (x *fastReflection_SignatureDescriptors) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptors.signatures":
		return len(x.Signatures) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.tx.signing.v1beta1.SignatureDescriptors"))
		}
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptors does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptors) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptors does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptors) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.tx.signing.v1beta1.SignatureDescriptors", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_tx_signing_v1beta1_signing_proto_init()
	md_SignatureDescriptor = File_cowsmouse_tx_signing_v1beta1_signing_proto.Messages().ByName("SignatureDescriptor")
...
func (x *SignatureDescriptor) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SignatureDescriptor) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.public_key":
		return x.PublicKey != nil
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.data":
		return x.Data != nil
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.sequence":
		return x.Sequence != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.tx.signing.v1beta1.SignatureDescriptor"))
		}
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.sequence":
		panic(fmt.Errorf("field sequence of message cowsmouse.tx.signing.v1beta1.SignatureDescriptor is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.tx.signing.v1beta1.SignatureDescriptor"))
		}
...
func (x *fastReflection_SignatureDescriptor) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.tx.signing.v1beta1.SignatureDescriptor", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_tx_signing_v1beta1_signing_proto_init()
	md_SignatureDescriptor_Data = File_cowsmouse_tx_signing_v1beta1_signing_proto.Messages().ByName("SignatureDescriptor").Messages().ByName("Data")
...
func (x *SignatureDescriptor_Data) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SignatureDescriptor_Data) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.single":
		if x.Sum == nil {
			return false
	...
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.multi":
		if x.Sum == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data"))
		}
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor_Data) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor_Data) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.sum":
		if x.Sum == nil {
			return nil
		}
		switch x.Sum.(type) {
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_tx_signing_v1beta1_signing_proto_init()
	md_SignatureDescriptor_Data_Single = File_cowsmouse_tx_signing_v1beta1_signing_proto.Messages().ByName("SignatureDescriptor").Messages().ByName("Data").Messages().ByName("Single")
...
func (x *SignatureDescriptor_Data_Single) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SignatureDescriptor_Data_Single) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single.mode":
		return x.Mode != 0
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single.signature":
		return len(x.Signature) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single"))
		}
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor_Data_Single) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor_Data_Single) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single.mode":
		panic(fmt.Errorf("field mode of message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single is not mutable"))
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single.signature":
		panic(fmt.Errorf("field signature of message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single"))
		}
...
func (x *fastReflection_SignatureDescriptor_Data_Single) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_tx_signing_v1beta1_signing_proto_init()
	md_SignatureDescriptor_Data_Multi = File_cowsmouse_tx_signing_v1beta1_signing_proto.Messages().ByName("SignatureDescriptor").Messages().ByName("Data").Messages().ByName("Multi")
...
func (x *SignatureDescriptor_Data_Multi) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SignatureDescriptor_Data_Multi) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi.bitarray":
		return x.Bitarray != nil
	case "cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi.signatures":
		return len(x.Signatures) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi"))
		}
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor_Data_Multi) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SignatureDescriptor_Data_Multi) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/tx/signing/v1beta1/signing.proto
...
func (SignMode) Descriptor() protoreflect.EnumDescriptor {
	return file_cowsmouse_tx_signing_v1beta1_signing_proto_enumTypes[0].Descriptor()
}

func (SignMode) Type() protoreflect.EnumType {
	return &file_cowsmouse_tx_signing_v1beta1_signing_proto_enumTypes[0]
}
...
func (SignMode) EnumDescriptor() ([]byte, []int) {
	return file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescGZIP(), []int{0}
}
...
func (*SignatureDescriptor) Descriptor() ([]byte, []int) {
	return file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescGZIP(), []int{1}
}
...
func (*SignatureDescriptor_Data) Descriptor() ([]byte, []int) {
	return file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescGZIP(), []int{1, 0}
}
...
type SignatureDescriptor_Data_Single struct {
	...
	Mode SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=cowsmouse.tx.signing.v1beta1.SignMode" json:"mode,omitempty"`
...
func (*SignatureDescriptor_Data_Single) Descriptor() ([]byte, []int) {
	return file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
func (*SignatureDescriptor_Data_Multi) Descriptor() ([]byte, []int) {
	return file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescGZIP(), []int{1, 0, 1}
}
...
var File_cowsmouse_tx_signing_v1beta1_signing_proto protoreflect.FileDescriptor

var file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDesc = []byte{
	,
	...
	0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x52, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72,
	0x65, 0x73, 0x22, 0x87, 0x05, 0x0a, 0x13, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65,
	0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x12, 0x33, 0x0a, 0x0a, 0x70, 0x75,
	...
	0x4a, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e,
	0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x74, 0x78, 0x2e, 0x73, 0x69, 0x67,
	...
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1a, 0x0a, 0x08, 0x73,
	0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x73,
	0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x1a, 0xd2, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	0x12, 0x57, 0x0a, 0x06, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x3d, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x74, 0x78, 0x2e,
	...
	0x74, 0x6f, 0x72, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x48,
	0x00, 0x52, 0x06, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x12, 0x54, 0x0a, 0x05, 0x6d, 0x75, 0x6c,
	0x74, 0x69, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3c, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d,
	0x6f, 0x75, 0x73, 0x65, 0x2e, 0x74, 0x78, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x2e,
	...
	0x62, 0x0a, 0x06, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x12, 0x3a, 0x0a, 0x04, 0x6d, 0x6f, 0x64,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f,
	0x75, 0x73, 0x65, 0x2e, 0x74, 0x78, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x2e, 0x76,
	...
	0x75, 0x72, 0x65, 0x1a, 0xaf, 0x01, 0x0a, 0x05, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x12, 0x4e, 0x0a,
	0x08, 0x62, 0x69, 0x74, 0x61, 0x72, 0x72, 0x61, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x32, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x63, 0x72, 0x79, 0x70,
	...
	0x72, 0x61, 0x79, 0x52, 0x08, 0x62, 0x69, 0x74, 0x61, 0x72, 0x72, 0x61, 0x79, 0x12, 0x56, 0x0a,
	0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x36, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x74, 0x78,
	...
	,
}

var (
	file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescOnce sync.Once
	file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescData = file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDesc
)

func file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescGZIP() []byte {
	file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescOnce.Do(func() {
		file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescData)
	})
	return file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDescData
}

var file_cowsmouse_tx_signing_v1beta1_signing_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cowsmouse_tx_signing_v1beta1_signing_proto_goTypes = []interface{}{
	(SignMode)(0),                           // 0: cowsmouse.tx.signing.v1beta1.SignMode
	(*SignatureDescriptors)(nil),            // 1: cowsmouse.tx.signing.v1beta1.SignatureDescriptors
	(*SignatureDescriptor)(nil),             // 2: cowsmouse.tx.signing.v1beta1.SignatureDescriptor
	(*SignatureDescriptor_Data)(nil),        // 3: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data
	(*SignatureDescriptor_Data_Single)(nil), // 4: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single
	(*SignatureDescriptor_Data_Multi)(nil),  // 5: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi
	(*anypb.Any)(nil),                       // 6: google.protobuf.Any
	(*v1beta1.CompactBitArray)(nil),         // 7: cowsmouse.crypto.multisig.v1beta1.CompactBitArray
}
var file_cowsmouse_tx_signing_v1beta1_signing_proto_depIdxs = []int32{
	2, // 0: cowsmouse.tx.signing.v1beta1.SignatureDescriptors.signatures:type_name -> cowsmouse.tx.signing.v1beta1.SignatureDescriptor
	6, // 1: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.public_key:type_name -> google.protobuf.Any
	3, // 2: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.data:type_name -> cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data
	4, // 3: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.single:type_name -> cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single
	5, // 4: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.multi:type_name -> cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi
	0, // 5: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Single.mode:type_name -> cowsmouse.tx.signing.v1beta1.SignMode
	7, // 6: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi.bitarray:type_name -> cowsmouse.crypto.multisig.v1beta1.CompactBitArray
	3, // 7: cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data.Multi.signatures:type_name -> cowsmouse.tx.signing.v1beta1.SignatureDescriptor.Data
...
func init() { file_cowsmouse_tx_signing_v1beta1_signing_proto_init() }
func file_cowsmouse_tx_signing_v1beta1_signing_proto_init() {
	if File_cowsmouse_tx_signing_v1beta1_signing_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_tx_signing_v1beta1_signing_proto_goTypes,
		DependencyIndexes: file_cowsmouse_tx_signing_v1beta1_signing_proto_depIdxs,
		EnumInfos:         file_cowsmouse_tx_signing_v1beta1_signing_proto_enumTypes,
		MessageInfos:      file_cowsmouse_tx_signing_v1beta1_signing_proto_msgTypes,
	}.Build()
	File_cowsmouse_tx_signing_v1beta1_signing_proto = out.File
	file_cowsmouse_tx_signing_v1beta1_signing_proto_rawDesc = nil
	file_cowsmouse_tx_signing_v1beta1_signing_proto_goTypes = nil
	file_cowsmouse_tx_signing_v1beta1_signing_proto_depIdxs = nil
}
