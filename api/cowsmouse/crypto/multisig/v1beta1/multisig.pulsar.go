...
func init() {
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_init()
	md_MultiSignature = File_cowsmouse_crypto_multisig_v1beta1_multisig_proto.Messages().ByName("MultiSignature")
...
func (x *MultiSignature) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_msgTypes[0]
...
func (x *fastReflection_MultiSignature) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.crypto.multisig.v1beta1.MultiSignature.signatures":
		return len(x.Signatures) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.crypto.multisig.v1beta1.MultiSignature"))
		}
		panic(fmt.Errorf("message cowsmouse.crypto.multisig.v1beta1.MultiSignature does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MultiSignature) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.crypto.multisig.v1beta1.MultiSignature does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MultiSignature) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.crypto.multisig.v1beta1.MultiSignature", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_init()
	md_CompactBitArray = File_cowsmouse_crypto_multisig_v1beta1_multisig_proto.Messages().ByName("CompactBitArray")
...
func (x *CompactBitArray) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CompactBitArray) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.crypto.multisig.v1beta1.CompactBitArray.extra_bits_stored":
		return x.ExtraBitsStored != uint32(0)
	case "cowsmouse.crypto.multisig.v1beta1.CompactBitArray.elems":
		return len(x.Elems) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.crypto.multisig.v1beta1.CompactBitArray"))
		}
		panic(fmt.Errorf("message cowsmouse.crypto.multisig.v1beta1.CompactBitArray does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CompactBitArray) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.crypto.multisig.v1beta1.CompactBitArray does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CompactBitArray) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.crypto.multisig.v1beta1.CompactBitArray.extra_bits_stored":
		panic(fmt.Errorf("field extra_bits_stored of message cowsmouse.crypto.multisig.v1beta1.CompactBitArray is not mutable"))
	case "cowsmouse.crypto.multisig.v1beta1.CompactBitArray.elems":
		panic(fmt.Errorf("field elems of message cowsmouse.crypto.multisig.v1beta1.CompactBitArray is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.crypto.multisig.v1beta1.CompactBitArray"))
		}
...
func (x *fastReflection_CompactBitArray) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.crypto.multisig.v1beta1.CompactBitArray", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/crypto/multisig/v1beta1/multisig.proto
...
// See cowsmouse.tx.v1betata1.ModeInfo.Multi for how to specify which signers
...
func (*MultiSignature) Descriptor() ([]byte, []int) {
	return file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescGZIP(), []int{0}
}
...
func (*CompactBitArray) Descriptor() ([]byte, []int) {
	return file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescGZIP(), []int{1}
}
...
var File_cowsmouse_crypto_multisig_v1beta1_multisig_proto protoreflect.FileDescriptor

var file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDesc = []byte{
	0x0a, 0x30, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x63, 0x72, 0x79, 0x70,
	...
	0x74, 0x6f, 0x12, 0x21, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x63, 0x72,
	...
	0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x36, 0x0a, 0x0e, 0x4d,
	...
	0x0c, 0x52, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x3a, 0x04, 0xd0,
	0xa1, 0x1f, 0x01, 0x22, 0x59, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x42, 0x69,
	...
	0x0c, 0x52, 0x05, 0x65, 0x6c, 0x65, 0x6d, 0x73, 0x3a, 0x04, 0x98, 0xa0, 0x1f, 0x00, 0x42, 0xa1,
	0x02, 0x0a, 0x25, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65,
	0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67,
	0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0d, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x73,
	0x69, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x42, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	...
	,
}

var (
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescOnce sync.Once
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescData = file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDesc
)

func file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescGZIP() []byte {
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescOnce.Do(func() {
		file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescData)
	})
	return file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDescData
}

var file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_goTypes = []interface{}{
	(*MultiSignature)(nil),  // 0: cowsmouse.crypto.multisig.v1beta1.MultiSignature
	(*CompactBitArray)(nil), // 1: cowsmouse.crypto.multisig.v1beta1.CompactBitArray
}
var file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_depIdxs = []int32{
...
func init() { file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_init() }
func file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_init() {
	if File_cowsmouse_crypto_multisig_v1beta1_multisig_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_goTypes,
		DependencyIndexes: file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_depIdxs,
		MessageInfos:      file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_msgTypes,
	}.Build()
	File_cowsmouse_crypto_multisig_v1beta1_multisig_proto = out.File
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_rawDesc = nil
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_goTypes = nil
	file_cowsmouse_crypto_multisig_v1beta1_multisig_proto_depIdxs = nil
}
