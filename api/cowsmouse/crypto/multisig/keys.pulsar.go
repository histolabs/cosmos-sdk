...
func init() {
	file_cowsmouse_crypto_multisig_keys_proto_init()
	md_LegacyAminoPubKey = File_cowsmouse_crypto_multisig_keys_proto.Messages().ByName("LegacyAminoPubKey")
...
func (x *LegacyAminoPubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_crypto_multisig_keys_proto_msgTypes[0]
...
func (x *fastReflection_LegacyAminoPubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.crypto.multisig.LegacyAminoPubKey.threshold":
		return x.Threshold != uint32(0)
	case "cowsmouse.crypto.multisig.LegacyAminoPubKey.public_keys":
		return len(x.PublicKeys) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.crypto.multisig.LegacyAminoPubKey"))
		}
		panic(fmt.Errorf("message cowsmouse.crypto.multisig.LegacyAminoPubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_LegacyAminoPubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.crypto.multisig.LegacyAminoPubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_LegacyAminoPubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cowsmouse.crypto.multisig.LegacyAminoPubKey.threshold":
		panic(fmt.Errorf("field threshold of message cowsmouse.crypto.multisig.LegacyAminoPubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.crypto.multisig.LegacyAminoPubKey"))
		}
...
func (x *fastReflection_LegacyAminoPubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.crypto.multisig.LegacyAminoPubKey", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/crypto/multisig/keys.proto
...
func (*LegacyAminoPubKey) Descriptor() ([]byte, []int) {
	return file_cowsmouse_crypto_multisig_keys_proto_rawDescGZIP(), []int{0}
}
...
var File_cowsmouse_crypto_multisig_keys_proto protoreflect.FileDescriptor

var file_cowsmouse_crypto_multisig_keys_proto_rawDesc = []byte{
	0x0a, 0x24, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x63, 0x72, 0x79, 0x70,
	0x74, 0x6f, 0x2f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x2f, 0x6b, 0x65, 0x79, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x19, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73,
	0x65, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc3, 0x01, 0x0a, 0x11, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79,
	...
	0x73, 0xa2, 0xe7, 0xb0, 0x2a, 0x07, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x73, 0x52, 0x0a, 0x70,
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x73, 0x3a, 0x40, 0x88, 0xa0, 0x1f, 0x00, 0x8a,
	...
	,
...
var (
	file_cowsmouse_crypto_multisig_keys_proto_rawDescOnce sync.Once
	file_cowsmouse_crypto_multisig_keys_proto_rawDescData = file_cowsmouse_crypto_multisig_keys_proto_rawDesc
)

func file_cowsmouse_crypto_multisig_keys_proto_rawDescGZIP() []byte {
	file_cowsmouse_crypto_multisig_keys_proto_rawDescOnce.Do(func() {
		file_cowsmouse_crypto_multisig_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_crypto_multisig_keys_proto_rawDescData)
	})
	return file_cowsmouse_crypto_multisig_keys_proto_rawDescData
}

var file_cowsmouse_crypto_multisig_keys_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_cowsmouse_crypto_multisig_keys_proto_goTypes = []interface{}{
	(*LegacyAminoPubKey)(nil), // 0: cowsmouse.crypto.multisig.LegacyAminoPubKey
	(*anypb.Any)(nil),         // 1: google.protobuf.Any
}
var file_cowsmouse_crypto_multisig_keys_proto_depIdxs = []int32{
	1, // 0: cowsmouse.crypto.multisig.LegacyAminoPubKey.public_keys:type_name -> google.protobuf.Any
...
func init() { file_cowsmouse_crypto_multisig_keys_proto_init() }
func file_cowsmouse_crypto_multisig_keys_proto_init() {
	if File_cowsmouse_crypto_multisig_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_crypto_multisig_keys_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_crypto_multisig_keys_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_crypto_multisig_keys_proto_goTypes,
		DependencyIndexes: file_cowsmouse_crypto_multisig_keys_proto_depIdxs,
		MessageInfos:      file_cowsmouse_crypto_multisig_keys_proto_msgTypes,
	}.Build()
	File_cowsmouse_crypto_multisig_keys_proto = out.File
	file_cowsmouse_crypto_multisig_keys_proto_rawDesc = nil
	file_cowsmouse_crypto_multisig_keys_proto_goTypes = nil
	file_cowsmouse_crypto_multisig_keys_proto_depIdxs = nil
}
