...
func init() {
	file_cowsmouse_crypto_hd_v1_hd_proto_init()
	md_BIP44Params = File_cowsmouse_crypto_hd_v1_hd_proto.Messages().ByName("BIP44Params")
...
func (x *BIP44Params) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_crypto_hd_v1_hd_proto_msgTypes[0]
...
func (x *fastReflection_BIP44Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.crypto.hd.v1.BIP44Params.purpose":
		return x.Purpose != uint32(0)
	case "cowsmouse.crypto.hd.v1.BIP44Params.coin_type":
		return x.CoinType != uint32(0)
	case "cowsmouse.crypto.hd.v1.BIP44Params.account":
		return x.Account != uint32(0)
	case "cowsmouse.crypto.hd.v1.BIP44Params.change":
		return x.Change != false
	case "cowsmouse.crypto.hd.v1.BIP44Params.address_index":
		return x.AddressIndex != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.crypto.hd.v1.BIP44Params"))
		}
		panic(fmt.Errorf("message cowsmouse.crypto.hd.v1.BIP44Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BIP44Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.crypto.hd.v1.BIP44Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BIP44Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.crypto.hd.v1.BIP44Params.purpose":
		panic(fmt.Errorf("field purpose of message cowsmouse.crypto.hd.v1.BIP44Params is not mutable"))
	case "cowsmouse.crypto.hd.v1.BIP44Params.coin_type":
		panic(fmt.Errorf("field coin_type of message cowsmouse.crypto.hd.v1.BIP44Params is not mutable"))
	case "cowsmouse.crypto.hd.v1.BIP44Params.account":
		panic(fmt.Errorf("field account of message cowsmouse.crypto.hd.v1.BIP44Params is not mutable"))
	case "cowsmouse.crypto.hd.v1.BIP44Params.change":
		panic(fmt.Errorf("field change of message cowsmouse.crypto.hd.v1.BIP44Params is not mutable"))
	case "cowsmouse.crypto.hd.v1.BIP44Params.address_index":
		panic(fmt.Errorf("field address_index of message cowsmouse.crypto.hd.v1.BIP44Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.crypto.hd.v1.BIP44Params"))
		}
...
func (x *fastReflection_BIP44Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.crypto.hd.v1.BIP44Params", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/crypto/hd/v1/hd.proto
...
func (*BIP44Params) Descriptor() ([]byte, []int) {
	return file_cowsmouse_crypto_hd_v1_hd_proto_rawDescGZIP(), []int{0}
}
...
var File_cowsmouse_crypto_hd_v1_hd_proto protoreflect.FileDescriptor

var file_cowsmouse_crypto_hd_v1_hd_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x63, 0x72, 0x79, 0x70,
	0x74, 0x6f, 0x2f, 0x68, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x68, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x16, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x63, 0x72, 0x79,
	0x70, 0x74, 0x6f, 0x2e, 0x68, 0x64, 0x2e, 0x76, 0x31, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e, 0x6f,
	...
	,
}

var (
	file_cowsmouse_crypto_hd_v1_hd_proto_rawDescOnce sync.Once
	file_cowsmouse_crypto_hd_v1_hd_proto_rawDescData = file_cowsmouse_crypto_hd_v1_hd_proto_rawDesc
)

func file_cowsmouse_crypto_hd_v1_hd_proto_rawDescGZIP() []byte {
	file_cowsmouse_crypto_hd_v1_hd_proto_rawDescOnce.Do(func() {
		file_cowsmouse_crypto_hd_v1_hd_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_crypto_hd_v1_hd_proto_rawDescData)
	})
	return file_cowsmouse_crypto_hd_v1_hd_proto_rawDescData
}

var file_cowsmouse_crypto_hd_v1_hd_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_cowsmouse_crypto_hd_v1_hd_proto_goTypes = []interface{}{
	(*BIP44Params)(nil), // 0: cowsmouse.crypto.hd.v1.BIP44Params
}
var file_cowsmouse_crypto_hd_v1_hd_proto_depIdxs = []int32{
...
func init() { file_cowsmouse_crypto_hd_v1_hd_proto_init() }
func file_cowsmouse_crypto_hd_v1_hd_proto_init() {
	if File_cowsmouse_crypto_hd_v1_hd_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_crypto_hd_v1_hd_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_crypto_hd_v1_hd_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_crypto_hd_v1_hd_proto_goTypes,
		DependencyIndexes: file_cowsmouse_crypto_hd_v1_hd_proto_depIdxs,
		MessageInfos:      file_cowsmouse_crypto_hd_v1_hd_proto_msgTypes,
	}.Build()
	File_cowsmouse_crypto_hd_v1_hd_proto = out.File
	file_cowsmouse_crypto_hd_v1_hd_proto_rawDesc = nil
	file_cowsmouse_crypto_hd_v1_hd_proto_goTypes = nil
	file_cowsmouse_crypto_hd_v1_hd_proto_depIdxs = nil
}
