...
const (
	Msg_SetWithdrawAddress_FullMethodName          = "/cowsmouse.distribution.v1beta1.Msg/SetWithdrawAddress"
	Msg_WithdrawDelegatorReward_FullMethodName     = "/cowsmouse.distribution.v1beta1.Msg/WithdrawDelegatorReward"
	Msg_WithdrawValidatorCommission_FullMethodName = "/cowsmouse.distribution.v1beta1.Msg/WithdrawValidatorCommission"
	Msg_FundCommunityPool_FullMethodName           = "/cowsmouse.distribution.v1beta1.Msg/FundCommunityPool"
	Msg_UpdateParams_FullMethodName                = "/cowsmouse.distribution.v1beta1.Msg/UpdateParams"
	Msg_CommunityPoolSpend_FullMethodName          = "/cowsmouse.distribution.v1beta1.Msg/CommunityPoolSpend"
	Msg_DepositValidatorRewardsPool_FullMethodName = "/cowsmouse.distribution.v1beta1.Msg/DepositValidatorRewardsPool"
)
