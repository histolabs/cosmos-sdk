...
const (
	Query_Params_FullMethodName                      = "/cowsmouse.distribution.v1beta1.Query/Params"
	Query_ValidatorDistributionInfo_FullMethodName   = "/cowsmouse.distribution.v1beta1.Query/ValidatorDistributionInfo"
	Query_ValidatorOutstandingRewards_FullMethodName = "/cowsmouse.distribution.v1beta1.Query/ValidatorOutstandingRewards"
	Query_ValidatorCommission_FullMethodName         = "/cowsmouse.distribution.v1beta1.Query/ValidatorCommission"
	Query_ValidatorSlashes_FullMethodName            = "/cowsmouse.distribution.v1beta1.Query/ValidatorSlashes"
	Query_DelegationRewards_FullMethodName           = "/cowsmouse.distribution.v1beta1.Query/DelegationRewards"
	Query_DelegationTotalRewards_FullMethodName      = "/cowsmouse.distribution.v1beta1.Query/DelegationTotalRewards"
	Query_DelegatorValidators_FullMethodName         = "/cowsmouse.distribution.v1beta1.Query/DelegatorValidators"
	Query_DelegatorWithdrawAddress_FullMethodName    = "/cowsmouse.distribution.v1beta1.Query/DelegatorWithdrawAddress"
	Query_CommunityPool_FullMethodName               = "/cowsmouse.distribution.v1beta1.Query/CommunityPool"
)
