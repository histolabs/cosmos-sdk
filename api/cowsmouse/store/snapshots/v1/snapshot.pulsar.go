...
func init() {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_init()
	md_Snapshot = File_cowsmouse_store_snapshots_v1_snapshot_proto.Messages().ByName("Snapshot")
...
func (x *Snapshot) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[0]
...
func (x *fastReflection_Snapshot) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.Snapshot.height":
		return x.Height != uint64(0)
	case "cowsmouse.store.snapshots.v1.Snapshot.format":
		return x.Format != uint32(0)
	case "cowsmouse.store.snapshots.v1.Snapshot.chunks":
		return x.Chunks != uint32(0)
	case "cowsmouse.store.snapshots.v1.Snapshot.hash":
		return len(x.Hash) != 0
	case "cowsmouse.store.snapshots.v1.Snapshot.metadata":
		return x.Metadata != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.Snapshot"))
		}
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.Snapshot does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Snapshot) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.Snapshot does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Snapshot) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cowsmouse.store.snapshots.v1.Snapshot.height":
		panic(fmt.Errorf("field height of message cowsmouse.store.snapshots.v1.Snapshot is not mutable"))
	case "cowsmouse.store.snapshots.v1.Snapshot.format":
		panic(fmt.Errorf("field format of message cowsmouse.store.snapshots.v1.Snapshot is not mutable"))
	case "cowsmouse.store.snapshots.v1.Snapshot.chunks":
		panic(fmt.Errorf("field chunks of message cowsmouse.store.snapshots.v1.Snapshot is not mutable"))
	case "cowsmouse.store.snapshots.v1.Snapshot.hash":
		panic(fmt.Errorf("field hash of message cowsmouse.store.snapshots.v1.Snapshot is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.Snapshot"))
		}
...
func (x *fastReflection_Snapshot) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.snapshots.v1.Snapshot", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_init()
	md_Metadata = File_cowsmouse_store_snapshots_v1_snapshot_proto.Messages().ByName("Metadata")
...
func (x *Metadata) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Metadata) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.Metadata.chunk_hashes":
		return len(x.ChunkHashes) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.Metadata"))
		}
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.Metadata does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Metadata) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.Metadata does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Metadata) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.snapshots.v1.Metadata", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_init()
	md_SnapshotItem = File_cowsmouse_store_snapshots_v1_snapshot_proto.Messages().ByName("SnapshotItem")
...
func (x *SnapshotItem) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SnapshotItem) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotItem.store":
		if x.Item == nil {
			return false
	...
	case "cowsmouse.store.snapshots.v1.SnapshotItem.iavl":
		if x.Item == nil {
			return false
	...
	case "cowsmouse.store.snapshots.v1.SnapshotItem.extension":
		if x.Item == nil {
			return false
	...
	case "cowsmouse.store.snapshots.v1.SnapshotItem.extension_payload":
		if x.Item == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotItem"))
		}
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotItem does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SnapshotItem) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotItem does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SnapshotItem) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotItem.item":
		if x.Item == nil {
			return nil
		}
		switch x.Item.(type) {
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.snapshots.v1.SnapshotItem", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_init()
	md_SnapshotStoreItem = File_cowsmouse_store_snapshots_v1_snapshot_proto.Messages().ByName("SnapshotStoreItem")
...
func (x *SnapshotStoreItem) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SnapshotStoreItem) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotStoreItem.name":
		return x.Name != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotStoreItem"))
		}
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotStoreItem does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SnapshotStoreItem) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotStoreItem does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SnapshotStoreItem) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotStoreItem.name":
		panic(fmt.Errorf("field name of message cowsmouse.store.snapshots.v1.SnapshotStoreItem is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotStoreItem"))
		}
...
func (x *fastReflection_SnapshotStoreItem) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.snapshots.v1.SnapshotStoreItem", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_init()
	md_SnapshotIAVLItem = File_cowsmouse_store_snapshots_v1_snapshot_proto.Messages().ByName("SnapshotIAVLItem")
...
func (x *SnapshotIAVLItem) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SnapshotIAVLItem) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.key":
		return len(x.Key) != 0
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.value":
		return len(x.Value) != 0
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.version":
		return x.Version != int64(0)
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.height":
		return x.Height != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotIAVLItem"))
		}
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotIAVLItem does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SnapshotIAVLItem) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotIAVLItem does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SnapshotIAVLItem) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.key":
		panic(fmt.Errorf("field key of message cowsmouse.store.snapshots.v1.SnapshotIAVLItem is not mutable"))
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.value":
		panic(fmt.Errorf("field value of message cowsmouse.store.snapshots.v1.SnapshotIAVLItem is not mutable"))
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.version":
		panic(fmt.Errorf("field version of message cowsmouse.store.snapshots.v1.SnapshotIAVLItem is not mutable"))
	case "cowsmouse.store.snapshots.v1.SnapshotIAVLItem.height":
		panic(fmt.Errorf("field height of message cowsmouse.store.snapshots.v1.SnapshotIAVLItem is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotIAVLItem"))
		}
...
func (x *fastReflection_SnapshotIAVLItem) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.snapshots.v1.SnapshotIAVLItem", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_init()
	md_SnapshotExtensionMeta = File_cowsmouse_store_snapshots_v1_snapshot_proto.Messages().ByName("SnapshotExtensionMeta")
...
func (x *SnapshotExtensionMeta) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SnapshotExtensionMeta) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotExtensionMeta.name":
		return x.Name != ""
	case "cowsmouse.store.snapshots.v1.SnapshotExtensionMeta.format":
		return x.Format != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotExtensionMeta"))
		}
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotExtensionMeta does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SnapshotExtensionMeta) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotExtensionMeta does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SnapshotExtensionMeta) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotExtensionMeta.name":
		panic(fmt.Errorf("field name of message cowsmouse.store.snapshots.v1.SnapshotExtensionMeta is not mutable"))
	case "cowsmouse.store.snapshots.v1.SnapshotExtensionMeta.format":
		panic(fmt.Errorf("field format of message cowsmouse.store.snapshots.v1.SnapshotExtensionMeta is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotExtensionMeta"))
		}
...
func (x *fastReflection_SnapshotExtensionMeta) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.snapshots.v1.SnapshotExtensionMeta", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_init()
	md_SnapshotExtensionPayload = File_cowsmouse_store_snapshots_v1_snapshot_proto.Messages().ByName("SnapshotExtensionPayload")
...
func (x *SnapshotExtensionPayload) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SnapshotExtensionPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotExtensionPayload.payload":
		return len(x.Payload) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotExtensionPayload"))
		}
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotExtensionPayload does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SnapshotExtensionPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.snapshots.v1.SnapshotExtensionPayload does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SnapshotExtensionPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.store.snapshots.v1.SnapshotExtensionPayload.payload":
		panic(fmt.Errorf("field payload of message cowsmouse.store.snapshots.v1.SnapshotExtensionPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.snapshots.v1.SnapshotExtensionPayload"))
		}
...
func (x *fastReflection_SnapshotExtensionPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.snapshots.v1.SnapshotExtensionPayload", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/store/snapshots/v1/snapshot.proto
...
func (*Snapshot) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP(), []int{0}
}
...
func (*Metadata) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP(), []int{1}
}
...
func (*SnapshotItem) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP(), []int{2}
}
...
func (*SnapshotStoreItem) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP(), []int{3}
}
...
func (*SnapshotIAVLItem) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP(), []int{4}
}
...
func (*SnapshotExtensionMeta) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP(), []int{5}
}
...
func (*SnapshotExtensionPayload) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP(), []int{6}
}
...
var File_cowsmouse_store_snapshots_v1_snapshot_proto protoreflect.FileDescriptor

var file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDesc = []byte{
	0x0a, 0x2b, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x2f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x73,
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1c, 0x63,
	0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x73,
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67, 0x6f, 0x67,
	0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x22, 0xb0, 0x01, 0x0a, 0x08, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x16,
	...
	,
	...
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x48, 0x00, 0x52, 0x10, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69,
	0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x06, 0x0a, 0x04, 0x69, 0x74, 0x65,
	0x6d, 0x22, 0x27, 0x0a, 0x11, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x53, 0x74, 0x6f,
	0x72, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x6c, 0x0a, 0x10, 0x53, 0x6e,
	0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x49, 0x41, 0x56, 0x4c, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x10,
	...
	0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x43, 0x0a, 0x15, 0x53, 0x6e, 0x61, 0x70,
	...
	,
}

var (
	file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescOnce sync.Once
	file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescData = file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDesc
)

func file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescGZIP() []byte {
	file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescOnce.Do(func() {
		file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescData)
	})
	return file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDescData
}

var file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_cowsmouse_store_snapshots_v1_snapshot_proto_goTypes = []interface{}{
	(*Snapshot)(nil),                 // 0: cowsmouse.store.snapshots.v1.Snapshot
	(*Metadata)(nil),                 // 1: cowsmouse.store.snapshots.v1.Metadata
	(*SnapshotItem)(nil),             // 2: cowsmouse.store.snapshots.v1.SnapshotItem
	(*SnapshotStoreItem)(nil),        // 3: cowsmouse.store.snapshots.v1.SnapshotStoreItem
	(*SnapshotIAVLItem)(nil),         // 4: cowsmouse.store.snapshots.v1.SnapshotIAVLItem
	(*SnapshotExtensionMeta)(nil),    // 5: cowsmouse.store.snapshots.v1.SnapshotExtensionMeta
	(*SnapshotExtensionPayload)(nil), // 6: cowsmouse.store.snapshots.v1.SnapshotExtensionPayload
}
var file_cowsmouse_store_snapshots_v1_snapshot_proto_depIdxs = []int32{
	1, // 0: cowsmouse.store.snapshots.v1.Snapshot.metadata:type_name -> cowsmouse.store.snapshots.v1.Metadata
	3, // 1: cowsmouse.store.snapshots.v1.SnapshotItem.store:type_name -> cowsmouse.store.snapshots.v1.SnapshotStoreItem
	4, // 2: cowsmouse.store.snapshots.v1.SnapshotItem.iavl:type_name -> cowsmouse.store.snapshots.v1.SnapshotIAVLItem
	5, // 3: cowsmouse.store.snapshots.v1.SnapshotItem.extension:type_name -> cowsmouse.store.snapshots.v1.SnapshotExtensionMeta
	6, // 4: cowsmouse.store.snapshots.v1.SnapshotItem.extension_payload:type_name -> cowsmouse.store.snapshots.v1.SnapshotExtensionPayload
...
func init() { file_cowsmouse_store_snapshots_v1_snapshot_proto_init() }
func file_cowsmouse_store_snapshots_v1_snapshot_proto_init() {
	if File_cowsmouse_store_snapshots_v1_snapshot_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_store_snapshots_v1_snapshot_proto_goTypes,
		DependencyIndexes: file_cowsmouse_store_snapshots_v1_snapshot_proto_depIdxs,
		MessageInfos:      file_cowsmouse_store_snapshots_v1_snapshot_proto_msgTypes,
	}.Build()
	File_cowsmouse_store_snapshots_v1_snapshot_proto = out.File
	file_cowsmouse_store_snapshots_v1_snapshot_proto_rawDesc = nil
	file_cowsmouse_store_snapshots_v1_snapshot_proto_goTypes = nil
	file_cowsmouse_store_snapshots_v1_snapshot_proto_depIdxs = nil
}
