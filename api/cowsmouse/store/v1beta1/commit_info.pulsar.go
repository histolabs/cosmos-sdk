...
func init() {
	file_cowsmouse_store_v1beta1_commit_info_proto_init()
	md_CommitInfo = File_cowsmouse_store_v1beta1_commit_info_proto.Messages().ByName("CommitInfo")
...
func (x *CommitInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes[0]
...
func (x *fastReflection_CommitInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.v1beta1.CommitInfo.version":
		return x.Version != int64(0)
	case "cowsmouse.store.v1beta1.CommitInfo.store_infos":
		return len(x.StoreInfos) != 0
	case "cowsmouse.store.v1beta1.CommitInfo.timestamp":
		return x.Timestamp != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.v1beta1.CommitInfo"))
		}
		panic(fmt.Errorf("message cowsmouse.store.v1beta1.CommitInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommitInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.v1beta1.CommitInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommitInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cowsmouse.store.v1beta1.CommitInfo.version":
		panic(fmt.Errorf("field version of message cowsmouse.store.v1beta1.CommitInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.v1beta1.CommitInfo"))
		}
...
func (x *fastReflection_CommitInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.v1beta1.CommitInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_v1beta1_commit_info_proto_init()
	md_StoreInfo = File_cowsmouse_store_v1beta1_commit_info_proto.Messages().ByName("StoreInfo")
...
func (x *StoreInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_StoreInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.v1beta1.StoreInfo.name":
		return x.Name != ""
	case "cowsmouse.store.v1beta1.StoreInfo.commit_id":
		return x.CommitId != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.v1beta1.StoreInfo"))
		}
		panic(fmt.Errorf("message cowsmouse.store.v1beta1.StoreInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoreInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.v1beta1.StoreInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoreInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cowsmouse.store.v1beta1.StoreInfo.name":
		panic(fmt.Errorf("field name of message cowsmouse.store.v1beta1.StoreInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.v1beta1.StoreInfo"))
		}
...
func (x *fastReflection_StoreInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.v1beta1.StoreInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_v1beta1_commit_info_proto_init()
	md_CommitID = File_cowsmouse_store_v1beta1_commit_info_proto.Messages().ByName("CommitID")
...
func (x *CommitID) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CommitID) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.v1beta1.CommitID.version":
		return x.Version != int64(0)
	case "cowsmouse.store.v1beta1.CommitID.hash":
		return len(x.Hash) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.v1beta1.CommitID"))
		}
		panic(fmt.Errorf("message cowsmouse.store.v1beta1.CommitID does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommitID) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.v1beta1.CommitID does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommitID) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.store.v1beta1.CommitID.version":
		panic(fmt.Errorf("field version of message cowsmouse.store.v1beta1.CommitID is not mutable"))
	case "cowsmouse.store.v1beta1.CommitID.hash":
		panic(fmt.Errorf("field hash of message cowsmouse.store.v1beta1.CommitID is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.v1beta1.CommitID"))
		}
...
func (x *fastReflection_CommitID) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.v1beta1.CommitID", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/store/v1beta1/commit_info.proto
...
func (*CommitInfo) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_v1beta1_commit_info_proto_rawDescGZIP(), []int{0}
}
...
func (*StoreInfo) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_v1beta1_commit_info_proto_rawDescGZIP(), []int{1}
}
...
func (*CommitID) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_v1beta1_commit_info_proto_rawDescGZIP(), []int{2}
}
...
var File_cowsmouse_store_v1beta1_commit_info_proto protoreflect.FileDescriptor

var file_cowsmouse_store_v1beta1_commit_info_proto_rawDesc = []byte{
	0x0a, 0x29, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x17, 0x63, 0x6f, 0x77,
	0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x62,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb5, 0x01, 0x0a, 0x0a,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x49, 0x0a, 0x0b, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x69, 0x6e,
	0x66, 0x6f, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x63, 0x6f, 0x77, 0x73,
	0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x04, 0xc8,
	0xde, 0x1f, 0x00, 0x52, 0x0a, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x12,
	0x42, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x03, 0x20, 0x01,
	...
	,
	...
	,
}

var (
	file_cowsmouse_store_v1beta1_commit_info_proto_rawDescOnce sync.Once
	file_cowsmouse_store_v1beta1_commit_info_proto_rawDescData = file_cowsmouse_store_v1beta1_commit_info_proto_rawDesc
)

func file_cowsmouse_store_v1beta1_commit_info_proto_rawDescGZIP() []byte {
	file_cowsmouse_store_v1beta1_commit_info_proto_rawDescOnce.Do(func() {
		file_cowsmouse_store_v1beta1_commit_info_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_store_v1beta1_commit_info_proto_rawDescData)
	})
	return file_cowsmouse_store_v1beta1_commit_info_proto_rawDescData
}

var file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_cowsmouse_store_v1beta1_commit_info_proto_goTypes = []interface{}{
	(*CommitInfo)(nil),            // 0: cowsmouse.store.v1beta1.CommitInfo
	(*StoreInfo)(nil),             // 1: cowsmouse.store.v1beta1.StoreInfo
	(*CommitID)(nil),              // 2: cowsmouse.store.v1beta1.CommitID
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_cowsmouse_store_v1beta1_commit_info_proto_depIdxs = []int32{
	1, // 0: cowsmouse.store.v1beta1.CommitInfo.store_infos:type_name -> cowsmouse.store.v1beta1.StoreInfo
	3, // 1: cowsmouse.store.v1beta1.CommitInfo.timestamp:type_name -> google.protobuf.Timestamp
	2, // 2: cowsmouse.store.v1beta1.StoreInfo.commit_id:type_name -> cowsmouse.store.v1beta1.CommitID
...
func init() { file_cowsmouse_store_v1beta1_commit_info_proto_init() }
func file_cowsmouse_store_v1beta1_commit_info_proto_init() {
	if File_cowsmouse_store_v1beta1_commit_info_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_store_v1beta1_commit_info_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_store_v1beta1_commit_info_proto_goTypes,
		DependencyIndexes: file_cowsmouse_store_v1beta1_commit_info_proto_depIdxs,
		MessageInfos:      file_cowsmouse_store_v1beta1_commit_info_proto_msgTypes,
	}.Build()
	File_cowsmouse_store_v1beta1_commit_info_proto = out.File
	file_cowsmouse_store_v1beta1_commit_info_proto_rawDesc = nil
	file_cowsmouse_store_v1beta1_commit_info_proto_goTypes = nil
	file_cowsmouse_store_v1beta1_commit_info_proto_depIdxs = nil
}
