...
func init() {
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_init()
	md_Pairs = File_cowsmouse_store_internal_kv_v1beta1_kv_proto.Messages().ByName("Pairs")
...
func (x *Pairs) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_internal_kv_v1beta1_kv_proto_msgTypes[0]
...
func (x *fastReflection_Pairs) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.internal.kv.v1beta1.Pairs.pairs":
		return len(x.Pairs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.internal.kv.v1beta1.Pairs"))
		}
		panic(fmt.Errorf("message cowsmouse.store.internal.kv.v1beta1.Pairs does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pairs) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.internal.kv.v1beta1.Pairs does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pairs) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.internal.kv.v1beta1.Pairs", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_init()
	md_Pair = File_cowsmouse_store_internal_kv_v1beta1_kv_proto.Messages().ByName("Pair")
...
func (x *Pair) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_internal_kv_v1beta1_kv_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Pair) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.internal.kv.v1beta1.Pair.key":
		return len(x.Key) != 0
	case "cowsmouse.store.internal.kv.v1beta1.Pair.value":
		return len(x.Value) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.internal.kv.v1beta1.Pair"))
		}
		panic(fmt.Errorf("message cowsmouse.store.internal.kv.v1beta1.Pair does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pair) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.internal.kv.v1beta1.Pair does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pair) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.store.internal.kv.v1beta1.Pair.key":
		panic(fmt.Errorf("field key of message cowsmouse.store.internal.kv.v1beta1.Pair is not mutable"))
	case "cowsmouse.store.internal.kv.v1beta1.Pair.value":
		panic(fmt.Errorf("field value of message cowsmouse.store.internal.kv.v1beta1.Pair is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.internal.kv.v1beta1.Pair"))
		}
...
func (x *fastReflection_Pair) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.internal.kv.v1beta1.Pair", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/store/internal/kv/v1beta1/kv.proto
...
func (*Pairs) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescGZIP(), []int{0}
}
...
func (*Pair) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescGZIP(), []int{1}
}
...
var File_cowsmouse_store_internal_kv_v1beta1_kv_proto protoreflect.FileDescriptor

var file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDesc = []byte{
	,
	...
	0xa2, 0x02, 0x04, 0x43, 0x53, 0x49, 0x4b, 0xaa, 0x02, 0x23, 0x43, 0x6f, 0x77, 0x73, 0x6d, 0x6f,
	0x75, 0x73, 0x65, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x2e, 0x4b, 0x76, 0x2e, 0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xca, 0x02, 0x23,
	0x43, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x5c, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x5c,
	0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5c, 0x4b, 0x76, 0x5c, 0x56, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0xe2, 0x02, 0x2f, 0x43, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x5c,
	...
	0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x27, 0x43, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73,
	0x65, 0x3a, 0x3a, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x3a, 0x3a, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x3a, 0x3a, 0x4b, 0x76, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescOnce sync.Once
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescData = file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDesc
)

func file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescGZIP() []byte {
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescOnce.Do(func() {
		file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescData)
	})
	return file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDescData
}

var file_cowsmouse_store_internal_kv_v1beta1_kv_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cowsmouse_store_internal_kv_v1beta1_kv_proto_goTypes = []interface{}{
	(*Pairs)(nil), // 0: cowsmouse.store.internal.kv.v1beta1.Pairs
	(*Pair)(nil),  // 1: cowsmouse.store.internal.kv.v1beta1.Pair
}
var file_cowsmouse_store_internal_kv_v1beta1_kv_proto_depIdxs = []int32{
	1, // 0: cowsmouse.store.internal.kv.v1beta1.Pairs.pairs:type_name -> cowsmouse.store.internal.kv.v1beta1.Pair
...
func init() { file_cowsmouse_store_internal_kv_v1beta1_kv_proto_init() }
func file_cowsmouse_store_internal_kv_v1beta1_kv_proto_init() {
	if File_cowsmouse_store_internal_kv_v1beta1_kv_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_store_internal_kv_v1beta1_kv_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pairs); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cowsmouse_store_internal_kv_v1beta1_kv_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pair); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_store_internal_kv_v1beta1_kv_proto_goTypes,
		DependencyIndexes: file_cowsmouse_store_internal_kv_v1beta1_kv_proto_depIdxs,
		MessageInfos:      file_cowsmouse_store_internal_kv_v1beta1_kv_proto_msgTypes,
	}.Build()
	File_cowsmouse_store_internal_kv_v1beta1_kv_proto = out.File
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_rawDesc = nil
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_goTypes = nil
	file_cowsmouse_store_internal_kv_v1beta1_kv_proto_depIdxs = nil
}
