...
import (
	v1beta1 "cosmossdk.io/api/cowsmouse/store/v1beta1"
...
func init() {
	file_cowsmouse_store_streaming_abci_grpc_proto_init()
	md_ListenFinalizeBlockRequest = File_cowsmouse_store_streaming_abci_grpc_proto.Messages().ByName("ListenFinalizeBlockRequest")
...
func (x *ListenFinalizeBlockRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[0]
...
func (x *fastReflection_ListenFinalizeBlockRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest.req":
		return x.Req != nil
	case "cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest.res":
		return x.Res != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest"))
		}
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ListenFinalizeBlockRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ListenFinalizeBlockRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_streaming_abci_grpc_proto_init()
	md_ListenFinalizeBlockResponse = File_cowsmouse_store_streaming_abci_grpc_proto.Messages().ByName("ListenFinalizeBlockResponse")
}
...
func (x *ListenFinalizeBlockResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ListenFinalizeBlockResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.streaming.abci.ListenFinalizeBlockResponse"))
		}
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenFinalizeBlockResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ListenFinalizeBlockResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenFinalizeBlockResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ListenFinalizeBlockResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.streaming.abci.ListenFinalizeBlockResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_streaming_abci_grpc_proto_init()
	md_ListenCommitRequest = File_cowsmouse_store_streaming_abci_grpc_proto.Messages().ByName("ListenCommitRequest")
...
func (x *ListenCommitRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ListenCommitRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.store.streaming.abci.ListenCommitRequest.block_height":
		return x.BlockHeight != int64(0)
	case "cowsmouse.store.streaming.abci.ListenCommitRequest.res":
		return x.Res != nil
	case "cowsmouse.store.streaming.abci.ListenCommitRequest.change_set":
		return len(x.ChangeSet) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.streaming.abci.ListenCommitRequest"))
		}
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenCommitRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ListenCommitRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenCommitRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ListenCommitRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cowsmouse.store.streaming.abci.ListenCommitRequest.block_height":
		panic(fmt.Errorf("field block_height of message cowsmouse.store.streaming.abci.ListenCommitRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.streaming.abci.ListenCommitRequest"))
		}
...
func (x *fastReflection_ListenCommitRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.streaming.abci.ListenCommitRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_store_streaming_abci_grpc_proto_init()
	md_ListenCommitResponse = File_cowsmouse_store_streaming_abci_grpc_proto.Messages().ByName("ListenCommitResponse")
}
...
func (x *ListenCommitResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ListenCommitResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.store.streaming.abci.ListenCommitResponse"))
		}
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenCommitResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ListenCommitResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.store.streaming.abci.ListenCommitResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ListenCommitResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.store.streaming.abci.ListenCommitResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/store/streaming/abci/grpc.proto
...
func (*ListenFinalizeBlockRequest) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_streaming_abci_grpc_proto_rawDescGZIP(), []int{0}
}
...
func (*ListenFinalizeBlockResponse) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_streaming_abci_grpc_proto_rawDescGZIP(), []int{1}
}
...
func (*ListenCommitRequest) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_streaming_abci_grpc_proto_rawDescGZIP(), []int{2}
}
...
func (*ListenCommitResponse) Descriptor() ([]byte, []int) {
	return file_cowsmouse_store_streaming_abci_grpc_proto_rawDescGZIP(), []int{3}
}

var File_cowsmouse_store_streaming_abci_grpc_proto protoreflect.FileDescriptor

var file_cowsmouse_store_streaming_abci_grpc_proto_rawDesc = []byte{
	,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x03, 0x72, 0x65, 0x71, 0x12, 0x38, 0x0a, 0x03, 0x72, 0x65, 0x73,
	...
	0x65, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x03,
	0x72, 0x65, 0x73, 0x22, 0x1d, 0x0a, 0x1b, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x46, 0x69, 0x6e,
	0x61, 0x6c, 0x69, 0x7a, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0xb0, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x43, 0x6f, 0x6d,
	0x6d, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c,
	...
	,
	...
	0x65, 0x42, 0xfc, 0x01, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f,
	0x75, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x69, 0x6e, 0x67, 0x2e, 0x61, 0x62, 0x63, 0x69, 0x42, 0x09, 0x47, 0x72, 0x70, 0x63, 0x50, 0x72,
	...
	,
}

var (
	file_cowsmouse_store_streaming_abci_grpc_proto_rawDescOnce sync.Once
	file_cowsmouse_store_streaming_abci_grpc_proto_rawDescData = file_cowsmouse_store_streaming_abci_grpc_proto_rawDesc
)

func file_cowsmouse_store_streaming_abci_grpc_proto_rawDescGZIP() []byte {
	file_cowsmouse_store_streaming_abci_grpc_proto_rawDescOnce.Do(func() {
		file_cowsmouse_store_streaming_abci_grpc_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_store_streaming_abci_grpc_proto_rawDescData)
	})
	return file_cowsmouse_store_streaming_abci_grpc_proto_rawDescData
}

var file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cowsmouse_store_streaming_abci_grpc_proto_goTypes = []interface{}{
	(*ListenFinalizeBlockRequest)(nil),  // 0: cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest
	(*ListenFinalizeBlockResponse)(nil), // 1: cowsmouse.store.streaming.abci.ListenFinalizeBlockResponse
	(*ListenCommitRequest)(nil),         // 2: cowsmouse.store.streaming.abci.ListenCommitRequest
	(*ListenCommitResponse)(nil),        // 3: cowsmouse.store.streaming.abci.ListenCommitResponse
	...
	(*v1beta1.StoreKVPair)(nil),         // 7: cowsmouse.store.v1beta1.StoreKVPair
}
var file_cowsmouse_store_streaming_abci_grpc_proto_depIdxs = []int32{
	4, // 0: cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest.req:type_name -> tendermint.abci.RequestFinalizeBlock
	5, // 1: cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest.res:type_name -> tendermint.abci.ResponseFinalizeBlock
	6, // 2: cowsmouse.store.streaming.abci.ListenCommitRequest.res:type_name -> tendermint.abci.ResponseCommit
	7, // 3: cowsmouse.store.streaming.abci.ListenCommitRequest.change_set:type_name -> cowsmouse.store.v1beta1.StoreKVPair
	0, // 4: cowsmouse.store.streaming.abci.ABCIListenerService.ListenFinalizeBlock:input_type -> cowsmouse.store.streaming.abci.ListenFinalizeBlockRequest
	2, // 5: cowsmouse.store.streaming.abci.ABCIListenerService.ListenCommit:input_type -> cowsmouse.store.streaming.abci.ListenCommitRequest
	1, // 6: cowsmouse.store.streaming.abci.ABCIListenerService.ListenFinalizeBlock:output_type -> cowsmouse.store.streaming.abci.ListenFinalizeBlockResponse
	3, // 7: cowsmouse.store.streaming.abci.ABCIListenerService.ListenCommit:output_type -> cowsmouse.store.streaming.abci.ListenCommitResponse
...
func init() { file_cowsmouse_store_streaming_abci_grpc_proto_init() }
func file_cowsmouse_store_streaming_abci_grpc_proto_init() {
	if File_cowsmouse_store_streaming_abci_grpc_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_store_streaming_abci_grpc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cowsmouse_store_streaming_abci_grpc_proto_goTypes,
		DependencyIndexes: file_cowsmouse_store_streaming_abci_grpc_proto_depIdxs,
		MessageInfos:      file_cowsmouse_store_streaming_abci_grpc_proto_msgTypes,
	}.Build()
	File_cowsmouse_store_streaming_abci_grpc_proto = out.File
	file_cowsmouse_store_streaming_abci_grpc_proto_rawDesc = nil
	file_cowsmouse_store_streaming_abci_grpc_proto_goTypes = nil
	file_cowsmouse_store_streaming_abci_grpc_proto_depIdxs = nil
}
