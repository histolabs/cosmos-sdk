...
const (
	ABCIListenerService_ListenFinalizeBlock_FullMethodName = "/cowsmouse.store.streaming.abci.ABCIListenerService/ListenFinalizeBlock"
	ABCIListenerService_ListenCommit_FullMethodName        = "/cowsmouse.store.streaming.abci.ABCIListenerService/ListenCommit"
)
