...
const (
	Query_Accounts_FullMethodName             = "/cowsmouse.auth.v1beta1.Query/Accounts"
	Query_Account_FullMethodName              = "/cowsmouse.auth.v1beta1.Query/Account"
	Query_AccountAddressByID_FullMethodName   = "/cowsmouse.auth.v1beta1.Query/AccountAddressByID"
	Query_Params_FullMethodName               = "/cowsmouse.auth.v1beta1.Query/Params"
	Query_ModuleAccounts_FullMethodName       = "/cowsmouse.auth.v1beta1.Query/ModuleAccounts"
	Query_ModuleAccountByName_FullMethodName  = "/cowsmouse.auth.v1beta1.Query/ModuleAccountByName"
	Query_Bech32Prefix_FullMethodName         = "/cowsmouse.auth.v1beta1.Query/Bech32Prefix"
	Query_AddressBytesToString_FullMethodName = "/cowsmouse.auth.v1beta1.Query/AddressBytesToString"
	Query_AddressStringToBytes_FullMethodName = "/cowsmouse.auth.v1beta1.Query/AddressStringToBytes"
	Query_AccountInfo_FullMethodName          = "/cowsmouse.auth.v1beta1.Query/AccountInfo"
)
