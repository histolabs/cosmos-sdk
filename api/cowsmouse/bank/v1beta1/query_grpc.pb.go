...
const (
	Query_Balance_FullMethodName                    = "/cowsmouse.bank.v1beta1.Query/Balance"
	Query_AllBalances_FullMethodName                = "/cowsmouse.bank.v1beta1.Query/AllBalances"
	Query_SpendableBalances_FullMethodName          = "/cowsmouse.bank.v1beta1.Query/SpendableBalances"
	Query_SpendableBalanceByDenom_FullMethodName    = "/cowsmouse.bank.v1beta1.Query/SpendableBalanceByDenom"
	Query_TotalSupply_FullMethodName                = "/cowsmouse.bank.v1beta1.Query/TotalSupply"
	Query_SupplyOf_FullMethodName                   = "/cowsmouse.bank.v1beta1.Query/SupplyOf"
	Query_Params_FullMethodName                     = "/cowsmouse.bank.v1beta1.Query/Params"
	Query_DenomMetadata_FullMethodName              = "/cowsmouse.bank.v1beta1.Query/DenomMetadata"
	Query_DenomMetadataByQueryString_FullMethodName = "/cowsmouse.bank.v1beta1.Query/DenomMetadataByQueryString"
	Query_DenomsMetadata_FullMethodName             = "/cowsmouse.bank.v1beta1.Query/DenomsMetadata"
	Query_DenomOwners_FullMethodName                = "/cowsmouse.bank.v1beta1.Query/DenomOwners"
	Query_SendEnabled_FullMethodName                = "/cowsmouse.bank.v1beta1.Query/SendEnabled"
)
