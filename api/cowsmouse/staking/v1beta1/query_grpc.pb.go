...
const (
	Query_Validators_FullMethodName                    = "/cowsmouse.staking.v1beta1.Query/Validators"
	Query_Validator_FullMethodName                     = "/cowsmouse.staking.v1beta1.Query/Validator"
	Query_ValidatorDelegations_FullMethodName          = "/cowsmouse.staking.v1beta1.Query/ValidatorDelegations"
	Query_ValidatorUnbondingDelegations_FullMethodName = "/cowsmouse.staking.v1beta1.Query/ValidatorUnbondingDelegations"
	Query_Delegation_FullMethodName                    = "/cowsmouse.staking.v1beta1.Query/Delegation"
	Query_UnbondingDelegation_FullMethodName           = "/cowsmouse.staking.v1beta1.Query/UnbondingDelegation"
	Query_DelegatorDelegations_FullMethodName          = "/cowsmouse.staking.v1beta1.Query/DelegatorDelegations"
	Query_DelegatorUnbondingDelegations_FullMethodName = "/cowsmouse.staking.v1beta1.Query/DelegatorUnbondingDelegations"
	Query_Redelegations_FullMethodName                 = "/cowsmouse.staking.v1beta1.Query/Redelegations"
	Query_DelegatorValidators_FullMethodName           = "/cowsmouse.staking.v1beta1.Query/DelegatorValidators"
	Query_DelegatorValidator_FullMethodName            = "/cowsmouse.staking.v1beta1.Query/DelegatorValidator"
	Query_HistoricalInfo_FullMethodName                = "/cowsmouse.staking.v1beta1.Query/HistoricalInfo"
	Query_Pool_FullMethodName                          = "/cowsmouse.staking.v1beta1.Query/Pool"
	Query_Params_FullMethodName                        = "/cowsmouse.staking.v1beta1.Query/Params"
)
