...
const (
	Query_Account_FullMethodName      = "/cowsmouse.circuit.v1.Query/Account"
	Query_Accounts_FullMethodName     = "/cowsmouse.circuit.v1.Query/Accounts"
	Query_DisabledList_FullMethodName = "/cowsmouse.circuit.v1.Query/DisabledList"
)
