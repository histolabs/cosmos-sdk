...
func init() {
	file_cowsmouse_evidence_v1beta1_query_proto_init()
	md_QueryEvidenceRequest = File_cowsmouse_evidence_v1beta1_query_proto.Messages().ByName("QueryEvidenceRequest")
...
func (x *QueryEvidenceRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[0]
...
func (x *fastReflection_QueryEvidenceRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.evidence.v1beta1.QueryEvidenceRequest.evidence_hash":
		return len(x.EvidenceHash) != 0
	case "cowsmouse.evidence.v1beta1.QueryEvidenceRequest.hash":
		return x.Hash != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.evidence.v1beta1.QueryEvidenceRequest"))
		}
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryEvidenceRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryEvidenceRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryEvidenceRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryEvidenceRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.evidence.v1beta1.QueryEvidenceRequest.evidence_hash":
		panic(fmt.Errorf("field evidence_hash of message cowsmouse.evidence.v1beta1.QueryEvidenceRequest is not mutable"))
	case "cowsmouse.evidence.v1beta1.QueryEvidenceRequest.hash":
		panic(fmt.Errorf("field hash of message cowsmouse.evidence.v1beta1.QueryEvidenceRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.evidence.v1beta1.QueryEvidenceRequest"))
		}
...
func (x *fastReflection_QueryEvidenceRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.evidence.v1beta1.QueryEvidenceRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_evidence_v1beta1_query_proto_init()
	md_QueryEvidenceResponse = File_cowsmouse_evidence_v1beta1_query_proto.Messages().ByName("QueryEvidenceResponse")
...
func (x *QueryEvidenceResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryEvidenceResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.evidence.v1beta1.QueryEvidenceResponse.evidence":
		return x.Evidence != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.evidence.v1beta1.QueryEvidenceResponse"))
		}
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryEvidenceResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryEvidenceResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryEvidenceResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryEvidenceResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.evidence.v1beta1.QueryEvidenceResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_evidence_v1beta1_query_proto_init()
	md_QueryAllEvidenceRequest = File_cowsmouse_evidence_v1beta1_query_proto.Messages().ByName("QueryAllEvidenceRequest")
...
func (x *QueryAllEvidenceRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryAllEvidenceRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest"))
		}
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryAllEvidenceRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryAllEvidenceRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_evidence_v1beta1_query_proto_init()
	md_QueryAllEvidenceResponse = File_cowsmouse_evidence_v1beta1_query_proto.Messages().ByName("QueryAllEvidenceResponse")
...
func (x *QueryAllEvidenceResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryAllEvidenceResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse.evidence":
		return len(x.Evidence) != 0
	case "cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse"))
		}
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryAllEvidenceResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryAllEvidenceResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/evidence/v1beta1/query.proto
...
func (*QueryEvidenceRequest) Descriptor() ([]byte, []int) {
	return file_cowsmouse_evidence_v1beta1_query_proto_rawDescGZIP(), []int{0}
}
...
func (*QueryEvidenceResponse) Descriptor() ([]byte, []int) {
	return file_cowsmouse_evidence_v1beta1_query_proto_rawDescGZIP(), []int{1}
}
...
func (*QueryAllEvidenceRequest) Descriptor() ([]byte, []int) {
	return file_cowsmouse_evidence_v1beta1_query_proto_rawDescGZIP(), []int{2}
}
...
func (*QueryAllEvidenceResponse) Descriptor() ([]byte, []int) {
	return file_cowsmouse_evidence_v1beta1_query_proto_rawDescGZIP(), []int{3}
}
...
var File_cowsmouse_evidence_v1beta1_query_proto protoreflect.FileDescriptor

var file_cowsmouse_evidence_v1beta1_query_proto_rawDesc = []byte{
	0x0a, 0x26, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x65, 0x76, 0x69, 0x64,
	0x65, 0x6e, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x71, 0x75, 0x65,
	0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f,
	0x75, 0x73, 0x65, 0x2e, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62,
	...
	0x6e, 0x79, 0x52, 0x08, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x64, 0x0a, 0x17,
	...
	0x6f, 0x6e, 0x22, 0x98, 0x01, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x6c, 0x6c, 0x45,
	0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x30, 0x0a, 0x08, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x14, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x08, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63,
	0x65, 0x12, 0x4a, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x65, 0x52, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xd1, 0x02,
	0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0xa1, 0x01, 0x0a, 0x08, 0x45, 0x76, 0x69, 0x64,
	0x65, 0x6e, 0x63, 0x65, 0x12, 0x30, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65,
	...
	,
	...
	0x65, 0x42, 0xf3, 0x01, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f,
	0x75, 0x73, 0x65, 0x2e, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62,
	...
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x65,
	...
	,
}

var (
	file_cowsmouse_evidence_v1beta1_query_proto_rawDescOnce sync.Once
	file_cowsmouse_evidence_v1beta1_query_proto_rawDescData = file_cowsmouse_evidence_v1beta1_query_proto_rawDesc
)

func file_cowsmouse_evidence_v1beta1_query_proto_rawDescGZIP() []byte {
	file_cowsmouse_evidence_v1beta1_query_proto_rawDescOnce.Do(func() {
		file_cowsmouse_evidence_v1beta1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_evidence_v1beta1_query_proto_rawDescData)
	})
	return file_cowsmouse_evidence_v1beta1_query_proto_rawDescData
}

var file_cowsmouse_evidence_v1beta1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cowsmouse_evidence_v1beta1_query_proto_goTypes = []interface{}{
	(*QueryEvidenceRequest)(nil),     // 0: cowsmouse.evidence.v1beta1.QueryEvidenceRequest
	(*QueryEvidenceResponse)(nil),    // 1: cowsmouse.evidence.v1beta1.QueryEvidenceResponse
	(*QueryAllEvidenceRequest)(nil),  // 2: cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest
	(*QueryAllEvidenceResponse)(nil), // 3: cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse
	(*anypb.Any)(nil),                // 4: google.protobuf.Any
	(*v1beta1.PageRequest)(nil),      // 5: cowsmouse.base.query.v1beta1.PageRequest
	(*v1beta1.PageResponse)(nil),     // 6: cowsmouse.base.query.v1beta1.PageResponse
}
var file_cowsmouse_evidence_v1beta1_query_proto_depIdxs = []int32{
	4, // 0: cowsmouse.evidence.v1beta1.QueryEvidenceResponse.evidence:type_name -> google.protobuf.Any
	5, // 1: cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest.pagination:type_name -> cowsmouse.base.query.v1beta1.PageRequest
	4, // 2: cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse.evidence:type_name -> google.protobuf.Any
	6, // 3: cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse.pagination:type_name -> cowsmouse.base.query.v1beta1.PageResponse
	0, // 4: cowsmouse.evidence.v1beta1.Query.Evidence:input_type -> cowsmouse.evidence.v1beta1.QueryEvidenceRequest
	2, // 5: cowsmouse.evidence.v1beta1.Query.AllEvidence:input_type -> cowsmouse.evidence.v1beta1.QueryAllEvidenceRequest
	1, // 6: cowsmouse.evidence.v1beta1.Query.Evidence:output_type -> cowsmouse.evidence.v1beta1.QueryEvidenceResponse
	3, // 7: cowsmouse.evidence.v1beta1.Query.AllEvidence:output_type -> cowsmouse.evidence.v1beta1.QueryAllEvidenceResponse
...
func init() { file_cowsmouse_evidence_v1beta1_query_proto_init() }
func file_cowsmouse_evidence_v1beta1_query_proto_init() {
	if File_cowsmouse_evidence_v1beta1_query_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_evidence_v1beta1_query_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_evidence_v1beta1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cowsmouse_evidence_v1beta1_query_proto_goTypes,
		DependencyIndexes: file_cowsmouse_evidence_v1beta1_query_proto_depIdxs,
		MessageInfos:      file_cowsmouse_evidence_v1beta1_query_proto_msgTypes,
	}.Build()
	File_cowsmouse_evidence_v1beta1_query_proto = out.File
	file_cowsmouse_evidence_v1beta1_query_proto_rawDesc = nil
	file_cowsmouse_evidence_v1beta1_query_proto_goTypes = nil
	file_cowsmouse_evidence_v1beta1_query_proto_depIdxs = nil
}
