...
func init() {
	file_cowsmouse_base_query_v1beta1_pagination_proto_init()
	md_PageRequest = File_cowsmouse_base_query_v1beta1_pagination_proto.Messages().ByName("PageRequest")
...
func (x *PageRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_base_query_v1beta1_pagination_proto_msgTypes[0]
...
func (x *fastReflection_PageRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.base.query.v1beta1.PageRequest.key":
		return len(x.Key) != 0
	case "cowsmouse.base.query.v1beta1.PageRequest.offset":
		return x.Offset != uint64(0)
	case "cowsmouse.base.query.v1beta1.PageRequest.limit":
		return x.Limit != uint64(0)
	case "cowsmouse.base.query.v1beta1.PageRequest.count_total":
		return x.CountTotal != false
	case "cowsmouse.base.query.v1beta1.PageRequest.reverse":
		return x.Reverse != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.base.query.v1beta1.PageRequest"))
		}
		panic(fmt.Errorf("message cowsmouse.base.query.v1beta1.PageRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PageRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.base.query.v1beta1.PageRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PageRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.base.query.v1beta1.PageRequest.key":
		panic(fmt.Errorf("field key of message cowsmouse.base.query.v1beta1.PageRequest is not mutable"))
	case "cowsmouse.base.query.v1beta1.PageRequest.offset":
		panic(fmt.Errorf("field offset of message cowsmouse.base.query.v1beta1.PageRequest is not mutable"))
	case "cowsmouse.base.query.v1beta1.PageRequest.limit":
		panic(fmt.Errorf("field limit of message cowsmouse.base.query.v1beta1.PageRequest is not mutable"))
	case "cowsmouse.base.query.v1beta1.PageRequest.count_total":
		panic(fmt.Errorf("field count_total of message cowsmouse.base.query.v1beta1.PageRequest is not mutable"))
	case "cowsmouse.base.query.v1beta1.PageRequest.reverse":
		panic(fmt.Errorf("field reverse of message cowsmouse.base.query.v1beta1.PageRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.base.query.v1beta1.PageRequest"))
		}
...
func (x *fastReflection_PageRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.base.query.v1beta1.PageRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_base_query_v1beta1_pagination_proto_init()
	md_PageResponse = File_cowsmouse_base_query_v1beta1_pagination_proto.Messages().ByName("PageResponse")
...
func (x *PageResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_base_query_v1beta1_pagination_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PageResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.base.query.v1beta1.PageResponse.next_key":
		return len(x.NextKey) != 0
	case "cowsmouse.base.query.v1beta1.PageResponse.total":
		return x.Total != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.base.query.v1beta1.PageResponse"))
		}
		panic(fmt.Errorf("message cowsmouse.base.query.v1beta1.PageResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PageResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.base.query.v1beta1.PageResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PageResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.base.query.v1beta1.PageResponse.next_key":
		panic(fmt.Errorf("field next_key of message cowsmouse.base.query.v1beta1.PageResponse is not mutable"))
	case "cowsmouse.base.query.v1beta1.PageResponse.total":
		panic(fmt.Errorf("field total of message cowsmouse.base.query.v1beta1.PageResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.base.query.v1beta1.PageResponse"))
		}
...
func (x *fastReflection_PageResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.base.query.v1beta1.PageResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cowsmouse/base/query/v1beta1/pagination.proto
...
func (*PageRequest) Descriptor() ([]byte, []int) {
	return file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescGZIP(), []int{0}
}
...
func (*PageResponse) Descriptor() ([]byte, []int) {
	return file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescGZIP(), []int{1}
}
...
var File_cowsmouse_base_query_v1beta1_pagination_proto protoreflect.FileDescriptor

var file_cowsmouse_base_query_v1beta1_pagination_proto_rawDesc = []byte{
	...
	0x1c, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e,
	0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x22, 0x88, 0x01,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x1f, 0x0a,
	0x0b, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0a, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x18,
	0x0a, 0x07, 0x72, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x07, 0x72, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x22, 0x3f, 0x0a, 0x0c, 0x50, 0x61, 0x67, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x6e, 0x65, 0x78, 0x74,
	...
	0x28, 0x04, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x82, 0x02, 0x0a, 0x20, 0x63, 0x6f,
	0x6d, 0x2e, 0x63, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x62, 0x61, 0x73, 0x65,
	0x2e, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0f,
	...
	,
}

var (
	file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescOnce sync.Once
	file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescData = file_cowsmouse_base_query_v1beta1_pagination_proto_rawDesc
)

func file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescGZIP() []byte {
	file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescOnce.Do(func() {
		file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescData)
	})
	return file_cowsmouse_base_query_v1beta1_pagination_proto_rawDescData
}

var file_cowsmouse_base_query_v1beta1_pagination_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cowsmouse_base_query_v1beta1_pagination_proto_goTypes = []interface{}{
	(*PageRequest)(nil),  // 0: cowsmouse.base.query.v1beta1.PageRequest
	(*PageResponse)(nil), // 1: cowsmouse.base.query.v1beta1.PageResponse
}
var file_cowsmouse_base_query_v1beta1_pagination_proto_depIdxs = []int32{
...
func init() { file_cowsmouse_base_query_v1beta1_pagination_proto_init() }
func file_cowsmouse_base_query_v1beta1_pagination_proto_init() {
	if File_cowsmouse_base_query_v1beta1_pagination_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_base_query_v1beta1_pagination_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_base_query_v1beta1_pagination_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_base_query_v1beta1_pagination_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cowsmouse_base_query_v1beta1_pagination_proto_goTypes,
		DependencyIndexes: file_cowsmouse_base_query_v1beta1_pagination_proto_depIdxs,
		MessageInfos:      file_cowsmouse_base_query_v1beta1_pagination_proto_msgTypes,
	}.Build()
	File_cowsmouse_base_query_v1beta1_pagination_proto = out.File
	file_cowsmouse_base_query_v1beta1_pagination_proto_rawDesc = nil
	file_cowsmouse_base_query_v1beta1_pagination_proto_goTypes = nil
	file_cowsmouse_base_query_v1beta1_pagination_proto_depIdxs = nil
}
