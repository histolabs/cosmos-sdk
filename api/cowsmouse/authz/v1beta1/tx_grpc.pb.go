...
const (
	Msg_Grant_FullMethodName  = "/cowsmouse.authz.v1beta1.Msg/Grant"
	Msg_Exec_FullMethodName   = "/cowsmouse.authz.v1beta1.Msg/Exec"
	Msg_Revoke_FullMethodName = "/cowsmouse.authz.v1beta1.Msg/Revoke"
)
