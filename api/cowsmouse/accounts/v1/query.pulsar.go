...
func init() {
	file_cowsmouse_accounts_v1_query_proto_init()
	md_AccountQueryRequest = File_cowsmouse_accounts_v1_query_proto.Messages().ByName("AccountQueryRequest")
...
func (x *AccountQueryRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_accounts_v1_query_proto_msgTypes[0]
...
func (x *fastReflection_AccountQueryRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.accounts.v1.AccountQueryRequest.target":
		return x.Target != ""
	case "cowsmouse.accounts.v1.AccountQueryRequest.request":
		return len(x.Request) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.accounts.v1.AccountQueryRequest"))
		}
		panic(fmt.Errorf("message cowsmouse.accounts.v1.AccountQueryRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AccountQueryRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.accounts.v1.AccountQueryRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AccountQueryRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.accounts.v1.AccountQueryRequest.target":
		panic(fmt.Errorf("field target of message cowsmouse.accounts.v1.AccountQueryRequest is not mutable"))
	case "cowsmouse.accounts.v1.AccountQueryRequest.request":
		panic(fmt.Errorf("field request of message cowsmouse.accounts.v1.AccountQueryRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.accounts.v1.AccountQueryRequest"))
		}
...
func (x *fastReflection_AccountQueryRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.accounts.v1.AccountQueryRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cowsmouse_accounts_v1_query_proto_init()
	md_AccountQueryResponse = File_cowsmouse_accounts_v1_query_proto.Messages().ByName("AccountQueryResponse")
...
func (x *AccountQueryResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cowsmouse_accounts_v1_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_AccountQueryResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cowsmouse.accounts.v1.AccountQueryResponse.response":
		return len(x.Response) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.accounts.v1.AccountQueryResponse"))
		}
		panic(fmt.Errorf("message cowsmouse.accounts.v1.AccountQueryResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AccountQueryResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cowsmouse.accounts.v1.AccountQueryResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AccountQueryResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cowsmouse.accounts.v1.AccountQueryResponse.response":
		panic(fmt.Errorf("field response of message cowsmouse.accounts.v1.AccountQueryResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cowsmouse.accounts.v1.AccountQueryResponse"))
		}
...
func (x *fastReflection_AccountQueryResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cowsmouse.accounts.v1.AccountQueryResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (*AccountQueryRequest) Descriptor() ([]byte, []int) {
	return file_cowsmouse_accounts_v1_query_proto_rawDescGZIP(), []int{0}
}
...
func (*AccountQueryResponse) Descriptor() ([]byte, []int) {
	return file_cowsmouse_accounts_v1_query_proto_rawDescGZIP(), []int{1}
}
...
var File_cowsmouse_accounts_v1_query_proto protoreflect.FileDescriptor

var file_cowsmouse_accounts_v1_query_proto_rawDesc = []byte{
	,
	...
	,
	...
	0x75, 0x73, 0x65, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2f, 0x76, 0x31, 0x3b,
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x41, 0x58,
	0xaa, 0x02, 0x15, 0x43, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x15, 0x43, 0x6f, 0x77, 0x73, 0x6d,
	0x6f, 0x75, 0x73, 0x65, 0x5c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x5c, 0x56, 0x31,
	0xe2, 0x02, 0x21, 0x43, 0x6f, 0x77, 0x73, 0x6d, 0x6f, 0x75, 0x73, 0x65, 0x5c, 0x41, 0x63, 0x63,
...
var (
	file_cowsmouse_accounts_v1_query_proto_rawDescOnce sync.Once
	file_cowsmouse_accounts_v1_query_proto_rawDescData = file_cowsmouse_accounts_v1_query_proto_rawDesc
)

func file_cowsmouse_accounts_v1_query_proto_rawDescGZIP() []byte {
	file_cowsmouse_accounts_v1_query_proto_rawDescOnce.Do(func() {
		file_cowsmouse_accounts_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_cowsmouse_accounts_v1_query_proto_rawDescData)
	})
	return file_cowsmouse_accounts_v1_query_proto_rawDescData
}

var file_cowsmouse_accounts_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cowsmouse_accounts_v1_query_proto_goTypes = []interface{}{
	(*AccountQueryRequest)(nil),  // 0: cowsmouse.accounts.v1.AccountQueryRequest
	(*AccountQueryResponse)(nil), // 1: cowsmouse.accounts.v1.AccountQueryResponse
}
var file_cowsmouse_accounts_v1_query_proto_depIdxs = []int32{
	0, // 0: cowsmouse.accounts.v1.Query.AccountQuery:input_type -> cowsmouse.accounts.v1.AccountQueryRequest
	1, // 1: cowsmouse.accounts.v1.Query.AccountQuery:output_type -> cowsmouse.accounts.v1.AccountQueryResponse
...
func init() { file_cowsmouse_accounts_v1_query_proto_init() }
func file_cowsmouse_accounts_v1_query_proto_init() {
	if File_cowsmouse_accounts_v1_query_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cowsmouse_accounts_v1_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cowsmouse_accounts_v1_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cowsmouse_accounts_v1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cowsmouse_accounts_v1_query_proto_goTypes,
		DependencyIndexes: file_cowsmouse_accounts_v1_query_proto_depIdxs,
		MessageInfos:      file_cowsmouse_accounts_v1_query_proto_msgTypes,
	}.Build()
	File_cowsmouse_accounts_v1_query_proto = out.File
	file_cowsmouse_accounts_v1_query_proto_rawDesc = nil
	file_cowsmouse_accounts_v1_query_proto_goTypes = nil
	file_cowsmouse_accounts_v1_query_proto_depIdxs = nil
}
