...
const (
	Msg_VerifyInvariant_FullMethodName = "/cowsmouse.crisis.v1beta1.Msg/VerifyInvariant"
	Msg_UpdateParams_FullMethodName    = "/cowsmouse.crisis.v1beta1.Msg/UpdateParams"
)
