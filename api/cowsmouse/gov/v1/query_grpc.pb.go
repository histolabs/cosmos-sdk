...
const (
	Query_Constitution_FullMethodName = "/cowsmouse.gov.v1.Query/Constitution"
	Query_Proposal_FullMethodName     = "/cowsmouse.gov.v1.Query/Proposal"
	Query_Proposals_FullMethodName    = "/cowsmouse.gov.v1.Query/Proposals"
	Query_Vote_FullMethodName         = "/cowsmouse.gov.v1.Query/Vote"
	Query_Votes_FullMethodName        = "/cowsmouse.gov.v1.Query/Votes"
	Query_Params_FullMethodName       = "/cowsmouse.gov.v1.Query/Params"
	Query_Deposit_FullMethodName      = "/cowsmouse.gov.v1.Query/Deposit"
	Query_Deposits_FullMethodName     = "/cowsmouse.gov.v1.Query/Deposits"
	Query_TallyResult_FullMethodName  = "/cowsmouse.gov.v1.Query/TallyResult"
)
