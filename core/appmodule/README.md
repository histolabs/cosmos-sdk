...
message Module {
  option (cosmos.app.v1alpha1.module) = {
    go_import: "github.com/cosmos/cosmos-sdk/v2/x/auth"
  };
...
Alternatively, the `depinject.Config` can be created via [pure Go code](https://github.com/cosmos/cosmos-sdk/v2/blob/v0.47.0-rc1/simapp/app_config.go).
