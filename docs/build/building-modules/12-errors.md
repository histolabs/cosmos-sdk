...
Registration of errors is handled via the [`errors` package](https://github.com/cosmos/cosmos-sdk/v2/blob/main/errors/errors.go).

Example:

```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/distribution/types/errors.go
```
...
Note, the Cosmos SDK provides a core set of *common* errors. These errors are defined in [`types/errors/errors.go`](https://github.com/cosmos/cosmos-sdk/v2/blob/main/types/errors/errors.go).
...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/bank/keeper/keeper.go#L141-L182
```
