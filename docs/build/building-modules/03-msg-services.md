...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/bank/types/tx.pb.go#L550-L568
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/bank/keeper/msg_server.go#L17-L19
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/bank/keeper/msg_server.go#L56
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/baseapp/msg_service_router.go#L160
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/proto/cosmos/base/abci/v1beta1/abci.proto#L93-L113
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/auth/vesting/msg_server.go#L76-L88
```
