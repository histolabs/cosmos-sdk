...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/9c1e8b247cd47b5d3decda6e86fbc3bc996ee5d7/types/tx_msg.go#L84-L88
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/baseapp/abci.go#L864-L894
```
