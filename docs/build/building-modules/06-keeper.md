...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/staking/keeper/keeper.go#L23-L31
```
...
For more, see an example of `keeper`'s [methods implementation from the `staking` module](https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/staking/keeper/keeper.go).
...
```go reference
https://github.com/cosmos/cosmos-sdk/v2/blob/v0.50.0-alpha.0/x/auth/keeper/account.go
```
