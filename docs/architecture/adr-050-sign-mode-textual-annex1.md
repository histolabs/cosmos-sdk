...
* Applies to:
    ...
    * strings whose `customtype` is `github.com/cosmos/cosmos-sdk/v2/types.Int` or `github.com/cosmos/cosmos-sdk/v2/types.Dec`
    * bytes whose `customtype` is `github.com/cosmos/cosmos-sdk/v2/types.Int` or `github.com/cosmos/cosmos-sdk/v2/types.Dec`
