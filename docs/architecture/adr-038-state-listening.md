...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/cosmos/cosmos-sdk/v2/blob/master/docs/building-modules/messages-and-queries.md#queries)
