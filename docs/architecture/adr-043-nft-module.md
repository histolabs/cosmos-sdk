...
NFTs are more than just crypto art, which is very helpful for accruing value to the Cosmos ecosystem. As a result, Cosmos Hub should implement NFT functions and enable a unified mechanism for storing and sending the ownership representative of NFTs as discussed in https://github.com/cosmos/cosmos-sdk/v2/discussions/9065.

As discussed in [#9065](https://github.com/cosmos/cosmos-sdk/v2/discussions/9065), several potential solutions can be considered:
...
* Initial discussion: https://github.com/cosmos/cosmos-sdk/v2/discussions/9065
* x/nft: initialize module: https://github.com/cosmos/cosmos-sdk/v2/pull/9174
* [ADR 033](https://github.com/cosmos/cosmos-sdk/v2/blob/main/docs/architecture/adr-033-protobuf-inter-module-comm.md)
