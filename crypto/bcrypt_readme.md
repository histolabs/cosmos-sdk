...
```bash
go test -v --bench github.com/cosmos/cosmos-sdk/v2/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/cosmos/cosmos-sdk/v2/crypto/keys/mintkey
...
PASS
ok  	github.com/cosmos/cosmos-sdk/v2/crypto/keys/mintkey	12.093s
```
